...
- The aim of the game is to enter 4 different rooms, collecting items before returning to the main room to complete the game.
...
- If the user collects all of the items before they run out of lives, they win the game.
